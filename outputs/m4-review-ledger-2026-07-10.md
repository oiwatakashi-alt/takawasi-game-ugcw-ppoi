...
| MICRO-01 | micro | Battle中reloadでBattle画面が復帰せず、第9ターンTheaterへ戻った。campaign mapのreloadは第9ターン/画面を保持 | 採用 | `outputs/m4-save-reload-probe-2026-07-10.json`で再現済み。Bの次wave受入条件にbattle save/reloadを入れる。今ターンの個別修正はしない |
