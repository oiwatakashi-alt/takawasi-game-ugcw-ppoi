...
- ブロッカー: TCP/22は到達するが既存ローカルSSH経路がauth_denied。HTTPSは404、release/vhost/reloadは未実行。証跡: `outputs/takawasi-vps-deploy-blocked-2026-07-10.md` / `outputs/takawasi-vps-preflight-1ce85dd.json`
