...
- 現マイルストーン: local screenshot QA完了・UI再編wave4完了・個人VPS SHA release preflight待ち
...
- 次の一手: local UIループはwave4で閉じ、現行HEADのSHA別release preflightを作り直す。個人VPSの認証復旧まではremote release/vhost/reload/live QA/rollbackを実行しない
