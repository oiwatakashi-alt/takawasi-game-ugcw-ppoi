...
- 次の一手: `outputs/m4-human-acceptance-pack-2026-07-10.md`を人間が実操作し、「もう一度遊びたい／条件付き続行／方式転換」と理由・条件を記入する。追加probeでcampaign reloadは保持、Battle中reloadはTheaterへ戻ることを確認済み。判定後に01_PLANのM5を閉じ、必要ならBの検証契約を次waveへ昇格する
...
- 現在ウェーブ: 009_M4方式比較・三窓レビュー完了・人間判定待ち(開始: 2026-07-10。計画は01_PLANのM5項目)
