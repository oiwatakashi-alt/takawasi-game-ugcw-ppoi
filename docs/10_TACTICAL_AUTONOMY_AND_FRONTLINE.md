...
- direct drag placement
- freehand line drawing
- advanced elevation-specific line-of-sight beyond current rectangle hill modifiers and deeper defilade/covered-position rules
...
- `FrontlineSegment.sketchPoints` stores the confirmed 2-5 point sketch inside BattleState.
...
- While drawing, the frontage preview shows `戦線描画 N/5`, uses crosshair styling, and renders draft points/line separately from saved sketch geometry.
- The player can place 2-5 points: point 1 becomes anchor intent, point 2 becomes fallback intent, and points 3-5 shape the width/curve intent.
...
- This is click-to-place 2-5 point editing. Drag/freehand curve editing is still a future improvement.
